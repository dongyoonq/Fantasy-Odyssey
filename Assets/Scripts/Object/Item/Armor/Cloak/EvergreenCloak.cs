...
public class EvergreenCloak: Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Cloak/Evergreen Cloak");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Cloak/Evergreen Cloak");
    }

    public EvergreenCloak(ArmorData data) : base(data)
    {
    }
