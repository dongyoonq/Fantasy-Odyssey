...
public class IronclawGauntlets : Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Gloves/Ironclaw Gauntlets");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Gloves/Ironclaw Gauntlets");
    }

    public IronclawGauntlets(ArmorData data) : base(data)
    {
    }
