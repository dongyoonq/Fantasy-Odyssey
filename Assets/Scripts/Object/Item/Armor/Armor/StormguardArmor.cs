...
public class StormguardArmor : Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Armor/Stormguard Armor");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Armor/Stormguard Armor");
    }

    public StormguardArmor(ArmorData data) : base(data)
    {
    }
