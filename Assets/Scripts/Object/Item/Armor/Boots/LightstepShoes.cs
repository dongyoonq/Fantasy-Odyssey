...
public class LightstepShoes : Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Boots/Lightstep Shoes");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Boots/Lightstep Shoes");
    }

    public LightstepShoes(ArmorData data) : base(data)
    {
    }
