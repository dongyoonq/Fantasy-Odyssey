...
public class ElderRavenLeggings : Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Pants/Elder Raven Leggings");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Pants/Elder Raven Leggings");
    }

    public ElderRavenLeggings(ArmorData data) : base(data)
    {
    }
