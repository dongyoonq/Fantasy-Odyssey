...
public class ShadowweaveTrousers : Armor
{
    private void OnEnable()
    {
        equipmentData = Resources.Load<EquipmentData>("Data/ItemData/ArmorData/Pants/Shadowweave Trousers");
        armorData = Resources.Load<ArmorData>("Data/ItemData/ArmorData/Pants/Shadowweave Trousers");
    }

    public ShadowweaveTrousers(ArmorData data) : base(data)
    {
    }
